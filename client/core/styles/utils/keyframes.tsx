...
export const fadeSlideInLeft = keyframes`
    0% {
...
export const fadeSlideOutRight = keyframes`
    0% {
        transform: translateX(0);
        opacity: 1;
    }
...
export const fadeSlideInBottom = keyframes`
    0% {
...
export const fadeSlideOutBottom = keyframes`
    0% {
        transform: translateY(0);
        opacity: 1;
    }
